...
public class TestMap : MonoBehaviour
{
    ...
    [SerializeField] private TestLocation location;
    ...
    {
        using UnityWebRequest request = UnityWebRequestTexture.GetTexture(string.Format(url, location.latitude, location.longitude, 20, MapsStaticAPIKey));
